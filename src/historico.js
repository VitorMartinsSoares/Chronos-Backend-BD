...
let selectPRC = function select(objVazio, res){
    obj = [[0]];
    let query = `SELECT afinal.professor.email,afinal.professor.nomeP,afinal.professorhorario.motivo,afinal.professorhorario.status,afinal.professorhorario.horario,afinal.recursos.numero,afinal.data.data,afinal.tipoderecursos.nome FROM afinal.professorhorario 
